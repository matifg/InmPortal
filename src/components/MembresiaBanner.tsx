...
const ADMIN_WHATSAPP = '5493329691846'; // +54 9 3329 69-1846
const WHATSAPP_URL = `https://wa.me/${ADMIN_WHATSAPP}?text=${encodeURIComponent(
  'Hola! Soy agente de Inmo360 y necesito activar mi membresía.'
)}`;
